          ...
          Practise Completed Exams
           ...
           <div className="flex">
              <input
                ...
                className="px-4 py-2 border placeholder:text-sm  bg-transparent rounded-lg w-56 border border-primary font-semibold"
              />
              <select
                value={sortAttribute}
                onChange={(e) => setSortAttribute(e.target.value)}
                className="ml-4 px-4 py-2 border text-sm rounded-lg w-56 bg-transparent text-gray-600 border-primary font-semibold"
              >
...
export default practiseCompletedExam;
